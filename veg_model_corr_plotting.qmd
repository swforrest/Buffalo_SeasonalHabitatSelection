...
buffalo.pheno.dry.mvmt <- readRDS("buffalo_pheno_mixed_corr_mvmt_10rs_shrubgrassref_dry_2025-05-27.rds")
buffalo.pheno.wet.mvmt <- readRDS("buffalo_pheno_mixed_corr_mvmt_10rs_shrubgrassref_wet_2025-05-27.rds")
...
# saveRDS(buffalo.pheno.dry.mvmt, file = paste0("buffalo_pheno_mixed_corr_mvmt_10rs_shrubgrassref_dry_", Sys.Date(), ".rds"))
# paste0("Model location: buffalo_pheno_mixed_corr_mvmt_10rs_shrubgrassref_dry_", Sys.Date(), ".rds")
...
# saveRDS(buffalo.pheno.wet.mvmt, file = paste0("buffalo_pheno_mixed_corr_mvmt_10rs_shrubgrassref_wet_", Sys.Date(), ".rds"))
# paste0("Model location: buffalo_pheno_mixed_corr_mvmt_10rs_shrubgrassref_wet_", Sys.Date(), ".rds")
...
ggsave(paste0("outputs/plots/pheno_model_mixed_corr_dry_mvmt_", Sys.Date(), ".png"), device = "png", 
...
ggsave(paste0("outputs/plots/pheno_model_mixed_corr_dry_mvmt_WITHOUT_MVMT_", Sys.Date(), ".png"), device = "png", 
...
ggsave(paste0("outputs/plots/pheno_model_mixed_corr_wet_mvmt_", Sys.Date(), ".png"), device = "png", 
       width = 150, height = 150, units = "mm", scale = 1, dpi = 600)
...
ggsave(paste0("outputs/plots/pheno_model_mixed_corr_wet_mvmt_WITHOUT_MVMT_", Sys.Date(), ".png"), device = "png", 
       width = 150, height = 60, units = "mm", scale = 1, dpi = 600)
...
ggsave(paste0("outputs/plots/pheno_model_mixed_corr_sl_dry_mvmt_", Sys.Date(), ".png"), device = "png", 
...
ggsave(paste0("outputs/plots/pheno_model_mixed_corr_ta_dry_mvmt_", Sys.Date(), ".png"), device = "png", 
...
ggsave(paste0("outputs/plots/pheno_model_mixed_corr_sl_wet_mvmt_", Sys.Date(), ".png"), device = "png", 
       width = 150, height = 100, units = "mm", scale = 1, dpi = 1000)
...
ggsave(paste0("outputs/plots/pheno_model_mixed_corr_ta_wet_mvmt_", Sys.Date(), ".png"), device = "png", 
       width = 150, height = 100, units = "mm", scale = 1, dpi = 600)
